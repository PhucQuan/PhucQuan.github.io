...
![image.png](/assets/images/insecure-deserialization/image-1.png)
...
![image.png](/assets/images/insecure-deserialization/image-2.png)
...
![image.png](/assets/images/insecure-deserialization/image-3.png)
...
![image.png](/assets/images/insecure-deserialization/image-4.png)
...
![image.png](/assets/images/insecure-deserialization/image-5.png)
...
![image.png](/assets/images/insecure-deserialization/image-6.png)

Và sau khi gửi request thì t có thể truy cập vào admin panel và có thể xóa tài khoản Carlos

![image.png](/assets/images/insecure-deserialization/image-7.png)
...
![image.png](/assets/images/insecure-deserialization/image-8.png)
...
![image.png](/assets/images/insecure-deserialization/image-9.png)
...
![image.png](/assets/images/insecure-deserialization/image-10.png)
...
![image.png](/assets/images/insecure-deserialization/image-11.png)
...
![image.png](/assets/images/insecure-deserialization/image-12.png)
...
![image.png](/assets/images/insecure-deserialization/image-13.png)
...
![image.png](/assets/images/insecure-deserialization/image-14.png)
...
![image.png](/assets/images/insecure-deserialization/image-15.png)
...
![image.png](/assets/images/insecure-deserialization/image-16.png)
...
![image.png](/assets/images/insecure-deserialization/image-17.png)
...
![image.png](/assets/images/insecure-deserialization/image-18.png)
...
![image.png](/assets/images/insecure-deserialization/image-19.png)

![image.png](/assets/images/insecure-deserialization/image-20.png)
...
![image.png](/assets/images/insecure-deserialization/image-21.png)
...
![image.png](/assets/images/insecure-deserialization/image-22.png)
...
![image.png](/assets/images/insecure-deserialization/image-23.png)
...
![image.png](/assets/images/insecure-deserialization/image-24.png)

![image.png](/assets/images/insecure-deserialization/image-25.png)
...
![image.png](/assets/images/insecure-deserialization/image-26.png)
...
![image.png](/assets/images/insecure-deserialization/image-27.png)
...
![image.png](/assets/images/insecure-deserialization/image-28.png)
...
![image.png](/assets/images/insecure-deserialization/image-29.png)
...
![image.png](/assets/images/insecure-deserialization/image-30.png)
...
![image.png](/assets/images/insecure-deserialization/image-31.png)
...
![image.png](/assets/images/insecure-deserialization/image-32.png)

## 1. Xác định lỗ hổng

- Sau khi đăng nhập bằng tài khoản `wiener:peter`, quan sát thấy **session cookie chứa một Java serialized object**.

![image.png](/assets/images/insecure-deserialization/image-33.png)

![image.png](/assets/images/insecure-deserialization/image-34.png)

- Truy cập thư mục `/backup/` và thu thập được source code của ứng dụng, bao gồm:
    - `AccessTokenUser.java`
    
    ![image.png](/assets/images/insecure-deserialization/image-35.png)
    
    - `ProductTemplate.java`

![image.png](/assets/images/insecure-deserialization/image-36.png)
...
![image.png](/assets/images/insecure-deserialization/image-37.png)

![image.png](/assets/images/insecure-deserialization/image-38.png)

Sau khi dán payload tạo ra vào cookie thì chúng ta có thể thấy được phản hồi từ server trả về là 500

![image.png](/assets/images/insecure-deserialization/image-39.png)
...
![image.png](/assets/images/insecure-deserialization/image-40.png)
...
![image.png](/assets/images/insecure-deserialization/image-41.png)
...
![image.png](/assets/images/insecure-deserialization/image-42.png)
...
Và để có thể hiểu rõ sâu hơn về các real-case thì các bạn có thể tham khảo bài viết tái tạo N-day của mình về lỗ hổng này :[https://phucquan.github.io/Security-Research/2026/04/07/n-day-post1.html](https://phucquan.github.io/security-research/2026/04/07/n-day-post1.html)
